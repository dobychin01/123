...
namespace WindowsFormsApp11
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            this.serviceTableAdapter3.Fill(this.aAADataSet1.Service);
        ...
        {
            {
                ...
                if (dialogResult == DialogResult.Yes)
                {
                    ...
                    string constring = @"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=AAA;Integrated Security=True";
        ...
        {
            string connecionString = @"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=AAA;Integrated Security=True";
